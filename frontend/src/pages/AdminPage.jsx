      ...
      <div style={{ flex: 1, padding: "40px", overflowY: "auto" }}>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    borderLeft: i === 0 ? "3px solid #c8a96e" : "1px solid #f0f0f0", // Subtle gold accent on revenue
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ borderBottom: "2px solid #eee" }}>
                    {["Order ID", "Customer", "Total", "Paid", "Delivered"].map(
                      (h) => (
                        <th
                          key={h}
                          style={{
                        ...
                        <span
                          style={{
                            ...
                            backgroundColor: order.isDelivered
                              ? "#e8f5e9"
                              : "#f3f3f3",
                            color: order.isDelivered ? "#2e7d32" : "#999",
                            borderRadius: "20px",
                          }}
                        >
                    ...
                    >
                      ...
                      <div style={{ gridColumn: "1 / -1" }}>
                        <label style={labelStyle}>
                          IMAGE URLS (comma separated) OR UPLOAD IMAGE
                        </label>
                      ...
                      <td style={{ padding: "12px 15px" }}>
                        <span
                          style={{
                            ...
                            fontWeight: "700",
                            backgroundColor:
                              product.countInStock > 0 ? "#e8f5e9" : "#ffebee",
                            color:
                              product.countInStock > 0 ? "#2e7d32" : "#c62828",
                            borderRadius: "20px",
                          }}
                        >
        ...
        {activeTab === "myorders" && (
          <div>
            ...
            {orders.filter(
              (o) => o.user?._id === user?._id || o.user === user?._id,
            ).length === 0 ? (
              <div
                style={{
                  textAlign: "center",
