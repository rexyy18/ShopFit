...
const OrderConfirmationPage = () => {
  ...
  return (
    <div style={{ maxWidth: "750px", margin: "60px auto", padding: "0 40px" }}>
      {/* Success Banner */}
      <div style={{
        ...
        <p style={{ color: "#999", fontSize: "12px", marginTop: "10px", letterSpacing: "1px" }}>
          ORDER ID: {order._id}
        </p>
      </div>
      ...
      <div style={{ backgroundColor: "#f9f9f9", padding: "30px", marginBottom: "40px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <div style={{
              width: "40px", height: "40px", borderRadius: "50%",
              backgroundColor: order.isPaid ? "#4CAF50" : "#ddd", color: "#fff",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: "18px", margin: "0 auto 8px",
            }}>
              {order.isPaid ? "✓" : "○"}
            </div>
            <p style={{ fontSize: "11px", fontWeight: "700", color: order.isPaid ? "#4CAF50" : "#999" }}>
              PAYMENT
            </p>
          </div>
          <div style={{ flex: 1, height: "2px", backgroundColor: "#ddd", margin: "0 10px" }} />
          <div style={{ textAlign: "center" }}>
            <div style={{
              width: "40px", height: "40px", borderRadius: "50%",
              backgroundColor: order.isDelivered ? "#4CAF50" : "#ddd", color: "#fff",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: "18px", margin: "0 auto 8px",
            }}>
              {order.isDelivered ? "✓" : "○"}
            </div>
            <p style={{ fontSize: "11px", fontWeight: "700", color: order.isDelivered ? "#4CAF50" : "#999" }}>
              DELIVERED
            </p>
          </div>
        </div>
      ...
      <div style={{ display: "flex", gap: "15px" }}>
        <button onClick={() => navigate("/")} style={{
          flex: 1, padding: "16px", backgroundColor: "#222", color: "#fff",
        ...
        <button onClick={() => navigate("/")} style={{
          flex: 1, padding: "16px", backgroundColor: "transparent", color: "#222",
          fontSize: "13px", fontWeight: "700", letterSpacing: "2px",
